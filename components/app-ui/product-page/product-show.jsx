    ...
    return (
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 p-6 md:p-10">
            ...
            <div className="flex flex-col space-y-8">
                <h1 className="text-4xl font-extrabold text-[#38271F] leading-tight">Illuminating Serum Primer – By Mills</h1>
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                    Discover the perfect product to meet your needs. Lorem ipsum dolor sit amet, 
                    consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.
                </p>
                <div className="flex items-center gap-4">
                    <p className="text-3xl font-extrabold text-[#38271F]">$100</p>
                    <p className="line-through text-lg text-gray-400">$121.54</p>
                </div>
                <div className="flex items-center gap-4">
                ...
                <div className="border-t border-[#af9e96] pt-4 space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="#" className="text-[#38271F] hover:underline">Serums</Link>, 
