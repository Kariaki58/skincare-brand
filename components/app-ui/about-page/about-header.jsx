    ...
    return (
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row gap-10 md:gap-16 items-center justify-center py-10 px-5">
            ...
            <div className="space-y-6 max-w-2xl text-center md:text-left">
                <h1 className={`uppercase text-[30px] md:text-[50px] leading-[40px] md:leading-[60px] text-black ${spectral.className} antialiased`}>Charlotte's Premier Hair Salon</h1>
                <p className={`text-xl ${outfit.className} leading-[24px] md:leading-[30px] text-white`}>
