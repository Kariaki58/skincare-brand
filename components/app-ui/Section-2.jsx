    ...
    return (
        <section className="mx-auto max-w-screen-xl mt-20 px-5 md:px-2 lg:px-0">
            <div className="text-center">
                ...
                <h3 className={`${shipporiAntique.className} my-6 text-white tracking-widest text-xl uppercase`}>WE OFFER Micro braids, Box braids, Comfortability & ALL THINGS Braiding</h3>
                <p className={`max-w-3xl text-white mx-auto text-lg font-bold leading-7 ${outfit.className} antialiased`}>
